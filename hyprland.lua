...
hl.config({
    general = {
        ...
        border_size = 2,
        col = {
            active_border = "rgb(ffb68a)",
            inactive_border = "rgb(28211e)",
        },
        layout = "scrolling",
    },
    decoration = {
...
hl.bind("SUPER + CTRL + TAB", hl.dsp.exec_cmd("ambxst run overview"))
hl.bind("SUPER + ESCAPE", hl.dsp.exec_cmd("ambxst run powermenu"))
hl.bind("SUPER + i", hl.dsp.exec_cmd("ambxst run config"))
...
hl.bind("SUPER + t", hl.dsp.exec_cmd("wezterm-gui"))
hl.bind("SUPER + SHIFT + w", hl.dsp.exec_cmd("qs ipc -p ~/.local/src/ambxst call wallpaper random ~/Pictures/Wallpapers"))
hl.bind("SUPER + w", hl.dsp.exec_cmd("zen-browser"))
hl.bind("SUPER + b", hl.dsp.exec_cmd("brave-browser-nightly"))
hl.bind("SUPER + e", hl.dsp.exec_cmd("thunar"))
hl.bind("CTRL + SUPER + s", hl.dsp.exec_cmd("hyprsunset -t 4500"))
hl.bind("CTRL + ALT + s", hl.dsp.exec_cmd("pkill hyprsunset"))
hl.bind("SUPER + SHIFT + o", hl.dsp.exec_cmd("~/.config/dcli/scripts/switch-shell.sh"))
hl.bind("SUPER + tab", hl.dsp.exec_cmd("hyprctl dispatch 'hl.dsp.focus({ workspace = \"e+1\" })'"))
hl.bind("SUPER + SHIFT + tab", hl.dsp.exec_cmd("hyprctl dispatch 'hl.dsp.focus({ workspace = \"e-1\" })'"))
hl.bind("SUPER + f", hl.dsp.exec_cmd("hyprctl dispatch 'hl.dsp.window.fullscreen({ mode = \"fullscreen\" })'"))
hl.bind("SUPER + SHIFT + f", hl.dsp.exec_cmd("hyprctl dispatch 'hl.dsp.window.fullscreen({ mode = \"maximized\" })'"))
